...
def text_write_centered_x(write_text, write_size, write_y):
    ...
    font_object = pygame.font.SysFont(font_name, write_size)
    text_surface = font_object.render(write_text, True, write_color)
    text_rectangle = text_surface.get_rect(center=(display_width / 2, write_y))
    text_surface_shadow = font_object.render(write_text, True, write_color_shadow)
    text_rectangle_shadow = text_surface_shadow.get_rect(center=(display_width / 2+1, write_y+1))
