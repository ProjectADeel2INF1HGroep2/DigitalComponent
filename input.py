...
def enter_resources(max_length, color, player):
    ...
    while not finished:
        pygame.draw.rect(gameDisplay, red, (125, 175, 300, 40))
        print_text(TINY_FONT, 125, 150, "Amount of " + color + " land " + player + " owns:", black)
